# -*- coding: utf-8 -*-
"""
Created on Wed Aug  4 11:35:18 2021
...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  4 11:17:09 2021
...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 08:49:10 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  9 12:17:58 2019
...
def testData(atype):
    ...
    if(atype=='All_Adversary'):
        data_dir_path = "Path to adversarial datasets"
        ...
        data_dir_path = 'Path to adversarial datasets'+atype
...
def selectConfiguration():
    ...
    [X_test,Y_test,typee,method]=testData(atype)
    for i in range(0,6):
        config = i
